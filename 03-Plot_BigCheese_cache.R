...
vars.quad.DSR <- c(F)
vars.to.plot.PSR <- c("hierbas", "pastos", "Mean_Shrub_Height_5m", "Mean_Shrub_Height_5m_CV",
                      "Mean_Shrub_Height_50m_CV", "prey", "LOSH")
...
vars.quad.DSR <- c(T)
vars.to.plot.PSR <- c("Shrub_All_5m", "otra", "Mean_Shrub_Height_5m", "hierbas_cv",
