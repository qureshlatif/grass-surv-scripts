...
p <- ggdraw() +
  draw_plot(p.Juniper_5m.PSR,   x = 0.,  y = 0.5, width = 0.5, height = 0.5) +
  draw_plot(p.Juniper_500m.PSR, x = 0.5, y = 0.5, width = 0.5, height = 0.5) +
  draw_plot(p.Yucca_5m.PSR,     x = 0,   y = 0,   width = 0.5, height = 0.5) +
  draw_plot(p.Mesquite_5m.PSR,  x = 0.5, y = 0,   width = 0.5, height = 0.5)
p <- ggdraw() +
  draw_plot(p, x = 0.05, y = 0, width = 0.95, height = 1) +
  draw_plot_label("Survival over 90 days", x = 0, y = 0.5, angle = 90, hjust = 0.5)

save_plot(str_c("Figure_PSR_", mod.nam, ".jpg"), p, ncol = 2, nrow = 2, dpi = 200)
